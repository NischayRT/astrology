...
export default function WhatsAppButton() {
  ...
  // Automatically minimize the button after 4 seconds
  useEffect(() => {
  ...
  return (
    <a
      ...
      href="https://wa.me/+919959 629 678" 
      target="_blank"
      ...
      style={{
        ...
        bottom: "15px",
        right: "15px",
        zIndex: 9999, // Ensures it stays on top of absolutely everything
        display: "flex",
        alignItems: "center",
        backgroundColor: "#25D366", // Official WhatsApp Green
        color: "white",
        padding: isExpanded ? "12px 20px" : "14px",
        borderRadius: "50px",
